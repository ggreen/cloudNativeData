...
import io.pivotal.services.pivotMart.streams.dao.RetailAnalyticsDAO;
...
public class RetailStreamAnalyticsServiceTest
{
	private static RetailStreamAnalyticsService subject;
	...
	throws Exception
	{
		...
		subject = new RetailStreamAnalyticsService();
